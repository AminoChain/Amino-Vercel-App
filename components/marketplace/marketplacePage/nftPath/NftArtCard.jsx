    ...
    <div className="w-1/4">
      <div className="w-full p-10 nftCells rounded-3xl">
        ...
        <div className="py-5">
          ...
          <div className=' font-satoshiBold text-2xl text-black'>Casper might add here</div>
        </div>
        ...
        <div className="flex justify-between items-end">
          <div className="flex flex-col">
            ...
            <div className=' font-satoshiRegular text-black'>{biobank}</div>
          </div>
          <div className="flex h-min justify-center">
            <Image src={aminoLogo2} alt="aminochain logo image" height={42} width={75}/>
          </div>
        </div>
      </div>
      <div className="flex w-4/5 p-4 justify-between items-center">
        <div className="w-1/3 font-satoshiLight text-sm text-main">Match Rate</div>
