    ...
    <div className="flex flex-row justify-between border-solid border-y-[1px] rounded-2xl border-main py-6 px-6 mt-6 align-middle">
      <div className="flex flex-col">
        ...
        <div className="flex flex-row">
          ...
          >
            ...
            />
            <p className="font-satoshiMedium text-base text-main">0-25%</p>
          </div>
          <div
            className="flex flex-row border-solid border rounded-full border-main py-2 px-4 cursor-pointer mr-4"
            onClick={() => {
          ...
          >
            ...
            />
            <p className="font-satoshiMedium text-base text-main">25-50%</p>
          </div>
          <div
            className="flex flex-row border-solid border rounded-full border-main py-2 px-4 cursor-pointer mr-4"
            onClick={() => {
          ...
          >
            ...
            />
            <p className="font-satoshiMedium text-base text-main">50-75%</p>
          </div>
          <div
            className="flex flex-row border-solid border rounded-full border-main py-2 px-4 cursor-pointer mr-4"
            onClick={() => {
          ...
          >
            ...
            />
            <p className="font-satoshiMedium text-base text-main">75-100%</p>
          </div>
        </div>
      </div>
      <div className="flex flex-col self-center w-1/2">
        ...
        <div className="flex flex-row align-middle">
          ...
          <p className="font-satoshiMedium text-main text-[16]">$0 - $0</p>
        </div>
      </div>
    </div>
  )
